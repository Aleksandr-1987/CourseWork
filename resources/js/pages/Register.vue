                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group row">
                                <label for="name" class="col-sm-4 col-form-label text-md-right">Введите имя</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-sm-4 col-form-label text-md-right">Введите email</label>
                                <div class="col-md-6">
